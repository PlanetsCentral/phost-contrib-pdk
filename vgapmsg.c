...
Boolean
WriteExternalMessage(RaceType_Def pRace, const char *pMessage)
{
  Uns16 lLength;
  char *lStr;
  Uns16 lCount;
  ...
  if (gPointerFile EQ 0) {
    ...
    gPointerFile =
          OpenUpdateFile(EXT_MSG_POINTER_FILE,
          GAME_DIR_ONLY | REWRITE_MODE | NO_MISSING_ERROR);
